...
# Figs 4, S3, S4, S12, S15, S22, S25, S26
...
##################################################################################
# make plot for paper
# effect of contact networks generated dynamically vs statically, Fig S22
# F=50, N=5
par(mar=c(6.1,6.1,5.1,2.1)) # change margin sizes

cont_F50_stat <- ggplot(powers_table, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
...
cont_F50_dynam <- ggplot(powers_table_cont_dynamepi, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.14,0.86), breaks=c(0.14,0.3,0.5,0.7,0.86)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=mycolors(10), drop=F, na.value="white") +
...
###############################################################################
## make plot for paper
# effect of missing contacts and difference between this power and power when not missing contacts, Figs S25, S26
# N=5, F=50, 200, 1000
par(mar=c(6.1,6.1,5.1,2.1)) # change margin sizes

cont_F50MExp <- ggplot(powers_table, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=mycolors(10), drop=F, na.value="white") +
...
cont_F200MExp <- ggplot(powers_table, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=mycolors(10), drop=F, na.value="white") +
...
cont_F1000MExp <- ggplot(powers_table, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=mycolors(10), drop=F, na.value="white") +
...
ggarrange(annF50, annF200, annF1000,
          cont_F50MExp, cont_F200MExp, cont_F1000MExp, 
          nrow=2, ncol=3, common.legend=T, legend="right",
          widths=c(1/3,1/3,1/3),
          heights=c(0.1,0.9))
...
########## difference in power for multi previous exposures ##################
## find dif in power w/ multiple previous exposures, F=50,200,1000, Fig S26
powers_table_dif50 <- powers_table50MExp[,(1:3)]
powers_table_dif50$power <- powers_table50MExp$power - powers_table50$power

powers_table_dif200 <- powers_table200MExp[,(1:3)]
powers_table_dif200$power <- powers_table200MExp$power - powers_table200$power

powers_table_dif1000 <- powers_table1000MExp[,(1:3)]
powers_table_dif1000$power <- powers_table1000MExp$power - powers_table1000$power

# change color scale, red=negative=less power w/ missing contacts
mybreaks <- c(seq(-55,-5,5),5) # 11, 1
mycolors_neg <- function(x)
{
  colors <- colorRampPalette(c("red","white"))( 11 )
  colors[1:x]
}
mycolors_pos <- function(x)
{
  colors <- colorRampPalette(c("white","blue"))( 1 )
  colors[2:x]
}


cont_F50MExpdif <- ggplot(powers_table_dif50, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=c(mycolors_neg(11), mycolors_pos(1)), drop=F, na.value="white") +
  theme_minimal() +
  labs(fill="Power") +
  xlab(expression(paste("Expected fraction infected (",italic(E)[italic(c)],")"))) +
  ylab(expression(paste("Coefficient of variation (",italic(C)[italic(c)],")"))) +
  theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank(),
        ...
        text=element_text(size=20), legend.text=element_text(size=20), legend.title = element_text(size=20),
        axis.text.x=element_text(angle=90, vjust=0.5), axis.ticks=element_line(),
        plot.margin=margin(t=8, r=-8, b=8, l=0), legend.key=element_rect())

cont_F200MExpdif <- ggplot(powers_table_dif200, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=c(mycolors_neg(11), mycolors_pos(1)), drop=F, na.value="white") +
  ...
  theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank(),
        ...
        axis.text.x=element_text(angle=90, vjust=0.5),
        axis.text.y=element_blank(), axis.ticks.length.y=unit(0.71, "cm"), axis.ticks.x=element_line(),
        plot.margin=margin(t=8, r=0, b=8, l=2), legend.key=element_rect())

cont_F1000MExpdif <- ggplot(powers_table_dif1000, aes(x=f_inf, y=cv, z=power)) +
  geom_contour_filled(breaks=mybreaks, show.legend=T) +
  scale_x_continuous(expand=c(0,0), limits=c(0.02,0.98), breaks=c(0.02,0.25,0.5,0.75,0.98)) +
  scale_y_continuous(expand=c(0,0), limits=c(0,3)) +
  scale_fill_manual(values=c(mycolors_neg(11), mycolors_pos(1)), drop=F, na.value="white") +
...
ggarrange(annF50, annF200, annF1000,
          cont_F50MExpdif, cont_F200MExpdif, cont_F1000MExpdif, 
          nrow=2, ncol=3, common.legend=T, legend="right",
          widths=c(1/3,1/3,1/3),
          heights=c(0.1,0.9))
