...
## Figs 4, 5, 6, 7, S5, S7, S8, S10, S13, S16


#################################################################################
## Parameter estimates plot for the discrete case (p_A vs p_B vs f_A), main text Fig 4
...
####################################################################
## Parameter estimates plot for the continuous case (k vs theta), main text Fig 5
...
## discrete and continuous, main text Fig 6
