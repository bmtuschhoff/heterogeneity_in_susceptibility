  ...
  for(f_inf in exp_frac_inf)
  {
	...
	# use bernoulli for each indiv to check if infected, store risk for those not infected
      ...
      {       
        ...
        # probabilities of not getting infected
        prob_I0 <- 1 - exp(-risk0)
...
sims <- 600
steps <- 6e5
naiveFile <- paste("inf2_naive_k",k,"_theta",theta,"_F",Focal,"_N",N,"_N2",N2,"_len",steps,"_sims",sims,"seed.csv", sep="")
prevFile <- paste("inf2_prev_k",k,"_theta",theta,"_F",Focal,"_N",N,"_N2",N2,"_len",steps,"_sims",sims,"seed.csv", sep="")
...
fileName <- paste("ContMC_k",k,"_theta",theta,"_F",Focal,"_N",N,"_N2",N2,"_len",steps,"_sims",sims,"seed.csv", sep="")
