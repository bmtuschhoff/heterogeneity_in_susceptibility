...
inf2_naive_old <- unlist(read.csv("inf2_naive_2gps_pA0.74809046024617_pB0.125477384938458_fA0.2_F5000_N100_N2100seed.csv", row.names=1), use.names=F)
...
filename <- paste("2gpsMC2gpsData_pA",p_a,"_pB",p_b,"_fA",f_a,"_F",Focal,"_N",N,"_N2",N2,"_len",steps,"_sims",sims,"_N100subseed.csv", sep="")
