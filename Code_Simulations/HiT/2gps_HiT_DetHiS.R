# Calculate power to detect heterogeneity in suscepitibility given contact (HiS) in the presence of heterogeneity in transmission in the discrete case (with 2 types) across parameter combinations using simulated contact tracing data and a likelihood ratio test
...
filename <- paste("2gpPowersHiT_fA",f_a_old,"_F",Focal,"_N",N,"_N2",N2,"_sims",num_sims,"HiTm0.5phi2cv03e0.98Lambseed.csv",sep="")
